...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"turn_gain": 1.1}, "turn_gain must not exceed 1"),
        ({"min_moving_control_ratio": 0.0}, "must be in"),
        ({"min_moving_control_ratio": 1.1}, "must be in"),
        ({"max_recovery_count": -1}, "must not be negative"),
        ({"turn_confirmation_samples": -1}, "must not be negative"),
